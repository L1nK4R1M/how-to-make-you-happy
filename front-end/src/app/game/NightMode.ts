...
import { Runner } from "./Runner";
    ...
    export class NightMode {
        ...
        placeStars() {
            ...
            for (var i = 0; i < NightMode.config.NUM_STARS; i++) {
                this.stars[i] = {};
                this.stars[i].x = GameUtils.getRandomNum(segmentSize * i, segmentSize * (i + 1));
                this.stars[i].y = GameUtils.getRandomNum(0, NightMode.config.STAR_MAX_Y);
